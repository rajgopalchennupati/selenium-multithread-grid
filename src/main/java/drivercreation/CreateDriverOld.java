...
public class CreateDriverOld {

	private static CreateDriverOld instance = null;
	...
	public static ThreadLocal<ExtentTest> testLogger = new ThreadLocal<ExtentTest>(); //we are not providing any initial value here, it will be set in test classes
	 ...
	 * @return CreateDriver
	 */
	public static CreateDriverOld getInstance() {
		if (instance == null) {
			instance = new CreateDriverOld();
		}
		return instance;
	}
